...
const BusinessHorizontalMarquee = () => {
  ...
  return (
    <div className="text-sm font-medium text-gray-700 h-auto mb-8 relative w-full sm:w-44 md:w-56 mx-auto px-4 sm:px-0">
...
const FeatureCard = ({
  ...
  return (
    <div
      className="relative flex flex-col p-3 sm:p-5 pr-3 sm:pr-5 bg-white transition-shadow duration-300 rounded-2xl sm:rounded-3xl h-full min-h-[280px] sm:min-h-[360px] border border-gray-200 overflow-hidden"
    ...
    >
      ...
      <div className="flex flex-col grow text-left relative z-20">
        <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-0 mt-0">
          {title}
        </h3>
        <p className="text-xs sm:text-sm text-gray-600 mb-0 max-w-[85%] mt-2 sm:mt-3 leading-snug">
          {description}
        </p>
        <div className="mt-auto mr-6 sm:mr-10">{ctaContent}</div>
      </div>
    </div>
  );
};
...
const SlidingCard = ({ 
  ...
  // Cards start visible with 10px spacing by default
  // Card 1: stays at top (y=0)
  // Card 2: starts at y=360 (350px card + 10px gap), slides up to y=0 during scroll
  // Card 3: starts at y=720 (360 + 360), slides up to y=0 during scroll
  const yPosition = scrollProgress ? (
    index === 0 
      ? useTransform(scrollProgress, [0, 1], [0, 0])
      : index === 1
      ? useTransform(scrollProgress, [0, 0.33, 0.66, 1], [360, 360, 0, 0])
      : useTransform(scrollProgress, [0, 0.33, 0.85, 1], [720, 720, 0, 0])
  ) : 0;
  ...
  return (
    <motion.div
      style={{
        y: yPosition,
        zIndex: index + 1 // Card 3 (index 2) has highest z-index, Card 1 (index 0) has lowest
      }}
      className="absolute lg:absolute static w-full mb-2.5 lg:mb-2.5 mb-4 lg:mb-0"
    >
...
const SlidingStackContainer = () => {
  ...
  // This ensures all cards follow the same scroll timeline
  ...
  return (
    <>
      {/* Desktop Stacking Animation (lg and above) */}
      <motion.section 
        ref={containerRef} 
        ...
        style={{
          height: useTransform(
            scrollYProgress,
            [0, 1],
            ["1050px", "350px"] // Collapse from 3 cards (350px each) to 1 card
          )
        }}
      >
        <div className="w-full relative" style={{ height: "1050px" }}>
          <SlidingCard
            index={0}
      ...
      {/* Mobile Card Stack (below lg) - Vertical Layout */}
      <section className="lg:hidden px-4 sm:px-6 py-6 sm:py-8">
        <SlidingCard
          index={0}
          imagePath={DUMMY_BUSINESS_STACKED_1}
          pillText="• Why you should save with us"
    ...
    <section className="w-full bg-white py-6 sm:py-8 md:py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-xl sm:text-2xl md:text-3xl font-semibold text-gray-900 leading-tight mt-0">
            grow with myStash.
          </p>
        </div>
      </div>
      ...
      <div className="w-full overflow-hidden">
        <div className="relative">
          ...
          <div className="absolute inset-y-0 left-0 w-12 sm:w-20 bg-linear-to-r from-white to-transparent z-10 pointer-events-none"></div>
          <div className="absolute inset-y-0 right-0 w-12 sm:w-20 bg-linear-to-l from-white to-transparent z-10 pointer-events-none"></div>
        </div>
      </div>
    </section>
  );
...
export default function BusinessPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full  bg-white -mb-16 sm:-mb-20 md:-mb-24 lg:-mb-10 overflow-hidden">
        ...
        {/* Four Corner Icons with updated positions - Hidden on mobile */}
        ...
        <div className="relative z-10 flex flex-col items-center justify-center lg:min-h-screen px-4 sm:px-6 lg:px-8 pt-16 sm:pt-12 md:pt-20 lg:pt-12  pb-16 sm:pb-32 md:pb-48 lg:pb-32">
          ...
          <div className="relative text-center max-w-4xl mx-auto w-full">
            ...
            <div className="relative z-20">
              {/* Line 1 */}
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-[54px] font-bold text-gray-900 mb-1 lg:mb-2">
              ...
              <div className="relative inline-block">
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-[54px] font-bold text-purple-600 mb-2 lg:mb-3">
                  Business
                </h1>
                {/* Underline */}
          ...
          {/* Two Line Sentence */}
          <div className="relative z-20 text-center max-w-2xl mx-auto mt-4 sm:mt-6 lg:mt-8 mb-6 sm:mb-10 lg:mb-12">
            <p className="text-base sm:text-lg md:text-xl lg:text-lg text-gray-600 mb-1">
             A smart financial tool designed for businesses to optimize cash flow, grow
            </p>
            <p className="text-base sm:text-lg md:text-xl lg:text-lg text-gray-600">
                your capital intelligently, and manage expenditures with confidence.
            </p>
          </div>
          {/* Download Button */}
          <div className="relative z-20 mt-2 sm:mt-4 lg:mt-6">
            <DownloadButton />
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 sm:pt-0 md:pt-24 pb-8 sm:pb-12 md:pb-20 bg-white">
        <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-12">
          <p className="text-xs sm:text-sm font-medium text-black mb-2 border border-gray-300 rounded-full px-3 sm:px-4 py-1 inline-block bg-transparent">
            • Our Products •
          </p>
      ...
      {/* Removed: <AppDownloadSection showHeaderAndLogos={true} /> */}
    </div>
  );
}